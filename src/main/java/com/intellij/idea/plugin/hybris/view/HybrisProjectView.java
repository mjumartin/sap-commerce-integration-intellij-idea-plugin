...
public class HybrisProjectView implements TreeStructureProvider, DumbAware {
    ...
    public Collection<AbstractTreeNode<?>> modify(
        ...
        final Collection<AbstractTreeNode<?>> childrenWithProcessedJunkFiles = this.processJunkFiles(
            children,
            settings
        );
    ...
    @Nullable
    @Override
    public Object getData(@NotNull final Collection<AbstractTreeNode<?>> selected, @NotNull final String dataId) {
        return null;
    }
}
